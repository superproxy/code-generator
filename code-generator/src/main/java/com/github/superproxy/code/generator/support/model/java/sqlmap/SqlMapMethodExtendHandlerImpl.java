...
public class SqlMapMethodExtendHandlerImpl implements SqlMapMethodExtendHandler {
    ...
    public SqlMapMethodExtendHandlerImpl() {
    }
...
//        limit :startIndex,:maxCount
    ...
    public void extendModel(Model model, Map extend) {
        ...
        extend.put(SqlExtendModel.NAME, getSqlMapName(dbJavaModel, dbJavaModel.getModelConfig()));
        extend.put(SqlExtendModel.INSERT, getInsertGenerator(dbJavaModel));
        extend.put(SqlExtendModel.INSERT2, getInsert2Generator(dbJavaModel));
        extend.put(SqlExtendModel.UPDATE, updateGenerator(dbJavaModel));
        extend.put(SqlExtendModel.QUERY_BY_ID, queryByIdGenerator(dbJavaModel));
        extend.put(SqlExtendModel.QUERY_BY_PAGE, queryByPageGenerator(dbJavaModel));
        extend.put(SqlExtendModel.QUERY_COUNT, queryCountGenerator(dbJavaModel));
        extend.put(SqlExtendModel.DELETE_BY_ID, deleteByIdGenerator(dbJavaModel));
    }
